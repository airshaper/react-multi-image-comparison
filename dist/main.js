...
function $6ed78c020e6666f8$export$e687473b8d6c8292(param) {
    ...
    var moveEvent = function(e) {
        if (activeHandle !== null) {
            ...
            setListWidths(Object.assign([], listWidths, (0, ($parcel$interopDefault($2Spwt$swchelperslib_define_propertyjs)))({}, activeHandle, elementPosition)));
            ...
            handlePositions.forEach(function(h, index) {
                if (activeHandle > index && handle.offsetLeft <= h) {
                    setHandlePositions(Object.assign([], handlePositions, (0, ($parcel$interopDefault($2Spwt$swchelperslib_define_propertyjs)))({}, index, handlePosition + 2)));
